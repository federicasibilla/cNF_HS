...
# ============================================================
# SCRIPT (yem mvam): conditioning on continuous ADM1 features
#                    household sampling by exact households-per-ADM1 levels
#                    + iterative feature removal outer loop
# ============================================================
...
OUTPUT_DIR = "/data/shared/fsibilla/clean_code/Q1/feature_importance/yem_mvam/results"
...
for feature_level in FEATURE_REMOVAL_LEVELS:
    ...
    cond_df_full = df[active_cond_cols].copy()
    ...
    # ==============================================================
    # MIDDLE LOOP: households-per-ADM1 levels
    # ==============================================================
    for hh_per_adm1 in HH_PER_ADM1_LEVELS:
        print(f"\n  ==============================")
        print(f"  HH-per-ADM1 level: {hh_per_adm1}")
        print(f"  ==============================")

        level_dir = os.path.join(OUTPUT_DIR, feat_name, f"train_{hh_per_adm1}_scaled")
        ...
        # ==============================================================
        for seed in SEEDS:
            print(f"\n  --- Seed {seed} | HH level {hh_per_adm1} | Features: {feat_name} ---")
            ...
            # Guaranteed first household per ADM1
            mandatory_hhs = []
            ...
            print(
                ...
                f"(target {n_hh_train_target}; level={hh_per_adm1} HH/ADM1), "
            ...
            complete_yem_scaled["feature_level"] = feat_name
