...
RESULTS_DIR = "/data/shared/fsibilla/clean_code/Q1/experiments/lka_vam/results"
OUTPUT_DIR  = "/data/shared/fsibilla/clean_code/Q1/bayesian/lka_vam/results"
...
for seed in SEEDS:
    ...
    # -------------------------------------------------------------------------
    # Load both raw and scaled training data for this seed
    # -------------------------------------------------------------------------
