...
RESULTS_DIR = "/data/shared/fsibilla/clean_code/Q1/experiments/lka_micron/results"
OUTPUT_DIR  = "/data/shared/fsibilla/clean_code/Q1/bayesian/lka_micron/results"

PSU_LEVEL = 1
SEEDS     = [1, 2, 3, 4, 5]    # one training subset per seed
N_RNVP    = 5                  # how many times to reinitialize and retrain RealNVP

TARGET_COLS    = [    'vita_rae_mcg',
