...
# ============================================================
# SCRIPT (moz vam): conditioning on one-hot(ADM1) +
...
OUTPUT_DIR = "/data/shared/fsibilla/clean_code/Q1/experiments_sectoronly/moz_vam/results"
...
for psu_per_adm1 in PSU_PER_ADM1_LEVELS:
    ...
    for seed in SEEDS:
        ...
        print(f"  -> Saved complete_moz_scaled to:\n     {complete_scaled_path}")
