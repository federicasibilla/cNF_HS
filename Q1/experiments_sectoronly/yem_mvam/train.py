...
# ============================================================
# SCRIPT 1/2 (yem mvam): conditioning on one-hot(ADM1),
...
OUTPUT_DIR = "/data/shared/fsibilla/clean_code/Q1/experiments_sectoronly/yem_mvam/results"
...
required_cols = [adm1_name_col, hh_id_col] + target_cols
missing = [c for c in required_cols if c not in df.columns]
if missing:
    raise ValueError(f"Missing required columns: {missing}")

need_cols = list(set(target_cols + [adm1_name_col, hh_id_col]))
