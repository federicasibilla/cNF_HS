...
OUTPUT_DIR = "/data/shared/fsibilla/clean_code/Q0/experiments/TVAE/lka_micron/results"
...
def main():
    ...
    for seed in SEEDS:
        ...
        real_out["seed"] = seed
        real_out_path = os.path.join(seed_dir, f"full_lka_cleaned_used_for_training_seed{seed}.csv")
