...
OUTPUT_DIR = "/data/shared/fsibilla/clean_code/Q0/experiments/cNF/nga_micron/results"
SEEDS = [1, 2, 3, 4, 5]
...
def main():
    ...
    for seed in SEEDS:
        ...
        complete_scaled_path = os.path.join(seed_dir, f"full_nga_scaled_seed{seed}.csv")
        complete_eth_scaled.to_csv(complete_scaled_path, index=False)
        print(f"-> Saved full_nga_scaled to:\n   {complete_scaled_path}")
